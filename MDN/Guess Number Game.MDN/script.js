...
var guessesPara = document.querySelector(".");
var lastResultPara = document.querySelector(".");
var lowOrHighPara = document.querySelector(".");

function getCurrentGuess() {
    currentGuess = parseInt(guessField.value);
    return currentGuess;
}

function isCurrentGuessCorrect() {
    return getCurrentGuess() === number ? true : false; 
}
